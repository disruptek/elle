...
pub struct VM {
    ...
    pub exception_handlers: Vec<ExceptionHandler>, // Stack of exception handlers
    pub current_exception: Option<Rc<crate::value::Exception>>, // Current exception being handled
}
